  ...
  >
    <v-card>
      <v-toolbar dark color="primary">
        ...
        <v-toolbar-title>Cadastro Forma de pagamento</v-toolbar-title>
        ...
        <v-card-text> 
          <v-form v-model="valid" lazy-validation ref="form">
            <v-card-title>
              ...
              <span class="title-span">Informação da Forma de pagamento</span>              
            </v-card-title>
...
export default class CadastroTipoDocumento extends Vue {
  @Prop() public item!: FormaPagamento;
  ...
  observer! : jsonpatch.Observer<FormaPagamento>; 
